...
public abstract class AbstractConfigurableJClientBase<R extends RequestEngineBuilder<?>, T
    extends AbstractConfigurableJClientBase<R, T>> extends JClientBase {

  private final HttpClientFactory<R> http;

  protected AbstractConfigurableJClientBase(String host, HttpClientFactory<R> http) {
    super(host, http);
    this.http = http;
  }

  protected AbstractConfigurableJClientBase(String host, String path, HttpClientFactory<R> http) {
